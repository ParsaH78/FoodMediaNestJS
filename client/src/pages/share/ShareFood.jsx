...
export default function ShareFood({user, post}) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (post) {
            dispatch(updatePost(post.id, newPost));
        } else {
            if (file) {
                let fileName = [];
                file.map(async (f) => {
            ...
            dispatch(createPost(newPost, navigate, user.id));
        }
    }
  ...
  return (
    <>
      ...
      <div className='shareContainer'>
        <Sidebar noCategory={true} user={user}/>
        <div className="share">
