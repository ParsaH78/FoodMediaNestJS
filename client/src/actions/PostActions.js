...
export const userPosts = (id) => async (dispatch) => {
    try {
        ...
        console.log("Error in getting user posts : ",  error.response);
    }
}
...
export const timelinePosts = () => async (dispatch) => {
    try {
        ...
        console.log("Error in getting timeline posts : ",  error.response);
    }
}
...
export const ratePost = (id, rate) => async (dispatch) => {
    try {
        ...
        console.log("Error in rate post : ",  error.response);
    }
}
...
export const addComment = (id, commentData) => async (dispatch) => {
    try {
        ...
        console.log("Error in add comment : ",  error.response);
    }
}
...
export const deleteComment = (id, commentId) => async (dispatch) => {
    try {
        ...
        console.log("Error in delete comment : ",  error.response);
    }
}
...
export const getTopPosts = () => async (dispatch) => {
  try {
    ...
    console.log("Error in getting top posts : ",  error.response);
  }
}
